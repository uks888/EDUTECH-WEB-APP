...
<?php if($resulti > 3)
       { ?>
        ...
        <iframe src="https://giphy.com/embed/5heRc94mvAatHzbofP" width="480" height="480" frameBorder="0" class="giphy-embed" allowFullScreen></iframe><p><a href="https://giphy.com/stickers/Dress2unDress-newin-dress2undressfashion-dress2undress-5heRc94mvAatHzbofP"></a></p>


       <?php }
       else
        { ?> 
          <iframe src="https://giphy.com/embed/45685UbEAB2natXGI4" width="480" height="480" frameBorder="0" class="giphy-embed" allowFullScreen></iframe><p><a href="https://giphy.com/stickers/45685UbEAB2natXGI4"></a></p>
...
<br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
 ...
 <button class="button1"><a href="profile1.php"><font color="white"><span>Previous </span></font></a></button>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
 
    <button class="button2" ><a href="profile_testt.php"><font color="white"><span>Next </span></font></a></button>
  </div>
</div>
</div><br><br>
