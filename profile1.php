...
if (!empty($_FILES["uploadedimage"]["name"])) { 
 ...
 if(move_uploaded_file($temp_name, $target_path)) { 
    $query_upload="INSERT INTO image (images_id,images_path,submission_date,uname) VALUES  
('','".$target_path."','".date("Y-m-d")."','$n')";  
...
<head>
  ...
  <!--bootstrap style-->
  <!-- <link rel="stylesheet" type="text/css" href="F:\xampp\htdocs\HACKATHON\CSS\bootstrap-4.3.1\dist\css\bootstrap.css"> -->
   <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/css/bootstrap.min.css" integrity="sha384-MCw98/SFnGE8fJT3GXwEOngsV7Zt27NXFoaoApmYm81iuXoPkFOJwJ8ERdknLPMO" crossorigin="anonymous">
   
  <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.6.3/css/all.css" integrity="sha384-UHRtZLI+pbxtHCWp1t77Bi1L4ZtiqrqD80Kn4Z8NTSRyMA2Fd33n5dQ8lWUE00s/" crossorigin="anonymous">
 <!---========for stopping back button========--->
    ...
    <div class="row text-center">
      <div class="col-md-12 col-sm-12 text-white">
       <?php
          ...
          $select_query = "SELECT * FROM image where uname='$n' ORDER BY images_id desc";
          $sql = mysqli_query($con,$select_query) or die(mysqli_error($con));   
          $row = mysqli_fetch_array($sql);
           $d= $row['images_path'];
         
        ?>
        <img class="fluid" id="profilepic" src="<?php  echo $d; ?>" width="200px">
...
<tr>
<td>
<input name="uploadnow" type="submit" value="Upload Image" id="imgs">
</td>
</tr>
</tbody></table>
</form>
<!--aaaaaaaaaaa!->> <--- code ends here for image upload ----->
      ...
      <div class="tab-pane fade show active" id="v-pills-test" role="tabpanel" aria-labelledby="v-pills-test-tab">
        <div class="container">
          ...
          Bootstrap is an open source toolkit for developing with HTML, CSS, and JS. Quickly prototype your ideas or build your entire app with our Sass variables and mixins, responsive grid system, extensive prebuilt components, and powerful plugins built on jQuery.<br><br>
            &nbsp&nbsp1. Every test contains 10 questions.<br>
            &nbsp&nbsp2. The student have to give mediocore test first, According to his/her performance he/she will be updated to next or below level test paper.<br>
            ...
            <div class="col-md-12 col-sm-12">
              <ul class="list-group">
                <li class="list-group-item list-group-item-primary test_list" id="a1">APTITUDE TESTS
                  <!-- Button trigger modal -->
                  <button type="button" class="btn btn-dark test_but" style="float: right;" data-toggle="modal" data-target=".bd-example-modal-xl">
                    Launch demo modal
                  </button></li>
                  ...
                  <div class="modal fade bd-example-modal-xl" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                              ...
                              <div class="container">
                                <div class="row">
                                  <div class="col-md-12">
                                    ...
                                    <p>Build responsive, mobile-first projects on the web with the world’s most popular front-end component library.
                                    Bootstrap is an open source toolkit for developing with HTML, CSS, and JS. Quickly prototype your ideas or build your entire app with our Sass variables and mixins, responsive grid system, extensive prebuilt components, and powerful plugins built on jQuery.<br><br>
                                      &nbsp&nbsp1. Every test contains 15 questions.<br>
                                      &nbsp&nbsp2. The student have to give mediocore test first, According to his/her performance he/she will be updated to next or below level test paper.<br>
                                      &nbsp&nbsp3. Each test will be of 20min only.<br>
                                      &nbsp&nbsp4. Best of Luck.
                                    </p>
                        ...
                        <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                          <button type="button" class="btn btn-primary text-white"><a href="profile_testc.php" style="color: white;text-decoration: none">Get Started</a></button>
                        </div>
                      </div>
                    </div>
                  </div>
<li class="list-group-item list-group-item-secondary test_list" id="a2">REASONING TESTS
                  <!-- Button trigger modal -->
                  <button type="button" class="btn btn-dark test_but" style="float: right;" data-toggle="modal" data-target=".bd-example-modal-xl">
                    Launch demo modal
                  </button></li>
...
<li class="list-group-item list-group-item-success test_list" id="a3">PERSONALITY TESTS
                  <!-- Button trigger modal -->
                  <button type="button" class="btn btn-dark test_but" style="float: right;" data-toggle="modal" data-target=".bd-example-modal-xl">
                    Launch demo modal
                  </button></li>
...
<li class="list-group-item list-group-item-danger test_list" id="a4">CODING TESTS
                  <!-- Button trigger modal -->
                  <button type="button" class="btn btn-dark test_but" style="float: right;" data-toggle="modal" data-target=".bd-example-modal-xl">
                    Launch demo modal
                  </button></li>
                  ...
                  <!-- Modal -->
                  <div class="modal fade bd-example-modal-xl coding" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title">INSTRUCTIONS</h5>
...
<li class="list-group-item list-group-item-warning test_list" id="a5">TECHNICAL TEST
                  <!-- Button trigger modal -->
                  <button type="button" class="btn btn-dark test_but" style="float: right;" data-toggle="modal" data-target=".bd-example-modal-xl">
                    Launch demo modal
                  </button></li>
...
<li class="list-group-item list-group-item-info test_list" id="a6">MOCK TEST
                  <!-- Button trigger modal -->
                  <button type="button" class="btn btn-dark test_but" style="float: right;" data-toggle="modal" data-target=".bd-example-modal-xl">
                    Launch demo modal
                  </button></li>
      ...
      <div class="tab-pane fade" id="v-pills-report" role="tabpanel" aria-labelledby="v-pills-report-tab">
         <div class="container">
          ...
          <div class="row dash_contentsubhead">
            <div class="col-md-12 col-sm-12">
              <h5>Your Assisment:</h5>
            </div>
          </div>
          <div class="row dash_content">
            <div class="col-md-12 col-sm-12">
              <table class="table table-striped">
 <?php $q = "select * from users where uname='".$_SESSION['name1']."' ";
              $query = mysqli_query($con , $q);
              $rows = mysqli_fetch_array($query); 
              $c="";
              if($rows==1)
  ...
  <thead>
    <tr>
      ...
      <th scope="col">Inorrect Answers</th>
  ...
  <tbody>
    <tr>
      <th scope="row">1</th>
      <td>5</td>
      <td><?php if($c==2 && $rows['levels']==1 && $rows['fields']==4){ echo $rows['$correctanswer'];} else{echo"_";}?></td>
      <td><?php if($c==2 && $rows['levels']==1 && $rows['fields']==4){echo 5-$rows['$correctanswer'];} else{echo"_";} ?></td>
      <td><?php if($c==2 && $rows['levels']==1 && $rows['fields']==4){echo $rows['$correctanswer']*2;} else{echo"_";} ?></td>
    </tr>
    <tr>
      <th scope="row">2</th>
      <td>5</td>
      <td><?php if($c==2 && $rows['levels']==2 && $rows['fields']==4){ echo $rows['$correctanswer'];} else{echo"_";} ?></td>
       <td><?php if($c==2 && $rows['levels']==2 && $rows['fields']==4){ echo 5-$rows['$correctanswer'];}else{echo"_";} ?></td> 
       <td><?php if($c==2 && $rows['levels']==2 && $rows['fields']==4){ echo $rows['$correctanswer']*2;}else{echo"_";} ?></td>
    ...
    <tr>
      <th scope="row">3</th>
      <td>5</td>
      <td><?php if($c==2 && $rows['levels']==3 && $rows['fields']==4){ echo $rows['$correctanswer'];}else{echo"_";} ?></td>
      <td><?php if($c==2 && $rows['levels']==3 && $rows['fields']==4){ echo 5-$rows['$correctanswer'];}else{echo"_";} ?></td>
      <td><?php if($c==2 && $rows['levels']==3 && $rows['fields']==4){ echo $rows['$correctanswer']*2;}else{echo"_";} ?></td>
  </tr>
  </tbody>
</table>
                    ...
                    <div class="row dash_content">
            <div class="col-md-12 col-sm-12 text-white">
              <h4>Get your graphical analysis here:</h4>
              <button type="button" class="btn btn-dark text-white"><a href="chartjs\js\bargraph.php" style="color: white;text-decoration: none;"> Graphical Analysis</a></button>
            </div>
          </div>
          <div class="row dash_contentsubhead">
            <div class="col-md-12 col-sm-12">
              <h5>Comparison with topper:</h5>
            </div>
          </div>
                    <div class="row dash_content">
            <div class="col-md-12 col-sm-12">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>8</td>
          ...
          <div class="row dash_content">
            <div class="col-md-12 col-sm-12 text-white">
              <h4>Graphical comparison with toppers:</h4>
              <button type="button" class="btn btn-dark text-white"><a href="bargraph.php" style="color: white;text-decoration: none;"> Graphical Analysis</a></button>
            </div>
          </div>
        </div>
      </div>
      <div class="tab-pane fade" id="v-pills-support" role="tabpanel" aria-labelledby="v-pills-support-tab">
         <div class="container">
          ...
          <div class="row dash_content">
            <div class="col-md-12 col-sm-12">
              <form>
                ...
                <div class="form-group">
                  <label for="exampleFormControlSelect1">Select the question:</label>
                ...
                <div class="form-group">
                  <label for="exampleFormControlTextarea1">Doubt:</label>
                  <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                </div>
                <form>
                <div class="form-group">
                  <label for="exampleFormControlFile1">Upload doubt image:</label>
          ...
          <div class="row dash_contentsubhead">
            <div class="col-md-12 col-sm-12">
              <h5>Download our questionpaper here:</h5>
            </div>
          </div>
          <div class="row dash_content">
            <div class="col-md-12 col-sm-12">
              ...
              <!--- Displaying links to download pdf format file--->
